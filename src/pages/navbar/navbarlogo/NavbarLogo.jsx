            ...
            <Card>
                ...
                >
                    ...
                    <Button
                        ...
                        color="white"
                        onClick={() =>
                            navigate("/dashboard/navbar/navbar-logo/add")
                        }
                    >
                                    ...
                                    <td className="border border-blue-gray-200 px-4 py-3 text-center">
                                        ...
                                        {item.logo && (
                                            ...
                                            <img
                                                ...
                                                className="h-14 w-45 object-cover rounded-lg mx-auto"
                                                alt=""
                                            />
                                    ...
                                    <td className="border border-blue-gray-200 px-4 py-3">
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            <Button
                                                ...
                                                onClick={() =>
                                                    navigate(
                                                        `/dashboard/navbar/navbar-logo/edit/${item.id}`
                                                    )
                                                }
                                            >
