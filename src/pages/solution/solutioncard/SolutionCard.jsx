...
export default function SolutionCard() {
    ...
    const fetchData = async () => {
        const res = await axios.get(`${BASE_URL}/api/solution-card`);
        setData(res.data);
    };
        ...
        <Card className="mt-12 mb-8 px-6">
            ...
            >
                ...
                <Button
                    ...
                    color="white"
                    onClick={() =>
                        navigate("/dashboard/solution/solution-card/add")
                    }
                >
                    Add
                </Button>
                                ...
                                <td className="border border-blue-gray-200 px-3 py-2">
                                    <div className="flex gap-2">
                                        <Button
                                            ...
                                            variant="outlined"
                                            onClick={() =>
                                                navigate(`/dashboard/solution/solution-card/edit/${item.id}`)
                                            }
                                        >
                                            Edit
                                        </Button>
                                        ...
                                        <Button
                                            ...
                                            color="red"
                                            onClick={async () => {
                                                await axios.delete(`${BASE_URL}/api/solution-card/${item.id}`);
                                                fetchData();
                                            }}
                                        >
                                            Delete
